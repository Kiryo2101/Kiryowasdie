...
if _G[string.sub(Hwid,  #Hwid/2,  #Hwid)] == nil then
    _G[string.sub(Hwid,  #Hwid/2,  #Hwid)] = 0
end
if game:GetService('CoreGui'):FindFirstChild(string.sub(Hwid,  #Hwid/2,  #Hwid)) then
    _G[string.sub(Hwid,  #Hwid/2,  #Hwid)] = _G[string.sub(Hwid,  #Hwid/2,  #Hwid)] + 1
end
local ProtectGui = protectgui or (syn and syn.protect_gui) or (function() end);

local ScreenGui = Instance.new('ScreenGui');
ProtectGui(ScreenGui);
ScreenGui.Name = string.sub(Hwid,  #Hwid/2,  #Hwid)
...
do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        function KeyPicker:Update()
            ...
            ContainerLabel.Text = string.format('[%s] %s (%s)', KeyPicker.Value, Info.Text, tostring(KeyPicker.Toggled));
...
function Library:WatermarkVisibility()
    return Library.Watermark.Visible
end;
